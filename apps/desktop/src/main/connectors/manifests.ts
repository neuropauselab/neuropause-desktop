...
export const CONNECTOR_MANIFESTS: ConnectorManifest[] = [
  ...
  },
  {
    ...
    name: 'Gmail',
    provider: 'Google',
    description: 'Index your Gmail messages and threads into your memory timeline.',
    category: 'communication',
    ...
    version: '1.0.0',
    authType: 'oauth2_pkce',
    capabilities: ['messages', 'conversations'],
    scopes: [
      {
        id: 'gmail.readonly',
        label: 'Gmail (read-only)',
        description: 'Read your email messages and threads.',
      },
    ],
    oauth: {
      authorizeUrl: GOOGLE_AUTHORIZE,
  ...
  },
  {
    ...
    provider: 'Google',
    description: 'Sync your Google Contacts into the people graph.',
    category: 'productivity',
  ...
  },
  {
    ...
    name: 'Google Tasks',
    provider: 'Google',
    description: 'Bring your Google Tasks and task lists into your work graph.',
    category: 'project_management',
