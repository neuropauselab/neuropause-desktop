...
import { attendanceModule, employeeModule, expenseClaimModule, holidayModule, leaveModule, shiftModule, payrollRegisterModule, payrollRunModule, payslipModule, salaryDisbursementModule, salaryStructureModule, statutoryFilingModule, statutoryRuleModule } from './modules/hr/hrInstances';
