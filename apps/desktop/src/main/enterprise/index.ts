...
import { employeeModule, payrollRegisterModule, payrollRunModule, payslipModule, salaryDisbursementModule, salaryStructureModule, statutoryRuleModule } from './modules/hr/hrInstances';
