 ...
 * `userData` (via the framework's canonical path), the shared AI engine, and
 * the Pricing Rules store (the W2.4 discount-policy ceiling). Mirrors the
 * CRM/Finance instance + the `*Instance.ts` pattern.
 */
...
import { pricingRuleModule } from './pricingRuleModuleInstance';
