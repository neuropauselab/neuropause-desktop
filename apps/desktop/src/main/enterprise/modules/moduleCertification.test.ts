 ...
 *
 * A QUALITY gate, not a feature: it runs every one of the 85 REAL registered module descriptors through the
...
const CERTIFIED: Record<string, EnterpriseModuleDescriptor[]> = {
  ...
  HR: [EMPLOYEE_DESCRIPTOR, PAYROLL_RUN_DESCRIPTOR, SALARY_STRUCTURE_DESCRIPTOR, STATUTORY_RULE_DESCRIPTOR],
...
const CERTIFIED_COUNTS: Record<string, number> = {
  Finance: 15, Sales: 7, CRM: 8, Procurement: 6, Inventory: 6, Warehouse: 8, Manufacturing: 12, Maintenance: 10, Projects: 4, HR: 4, Helpdesk: 1, Documents: 1, Executive: 3,
};
...
describe('Enterprise Module Certification — registry lock', () => {
  it('certifies exactly 85 modules across the 13 production families', () => {
