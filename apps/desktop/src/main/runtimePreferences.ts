...
declareStoreScope({
  ...
  retention:
    'One record with one boolean, rewritten whole on every change. No list, no cap, no eviction: a ' +
    'write can remove nothing except the previous value of `loginAtStartup`.',
  reason:
