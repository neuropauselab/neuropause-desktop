...
export const SECTIONS: SectionDef[] = [
  ...
  { id: 'administration', label: 'Administration', icon: 'shield', phase: 10, placement: 'primary' },
  // Phase 2 — reuse-only workspaces (Intelligence / Collaboration / Knowledge / Automation).
  { id: 'intelligence', label: 'Intelligence', icon: 'lightbulb', phase: 10, placement: 'primary' },
  { id: 'collaboration', label: 'Collaboration', icon: 'checklist', phase: 10, placement: 'primary' },
  { id: 'knowledge', label: 'Knowledge', icon: 'doc', phase: 10, placement: 'primary' },
