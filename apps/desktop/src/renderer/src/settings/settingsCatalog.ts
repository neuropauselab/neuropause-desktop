...
export const SETTINGS_DOMAINS: SettingsDomain[] = [
  {
    ...
    label: 'Identity',
    icon: 'user',
    summary: 'Profile, organizations, roles, connected accounts',
  },
  {
    id: 'security',
    label: 'Security',
    icon: 'shield',
    summary: 'Two-factor policy, trusted devices, recovery',
  },
  {
    id: 'governance',
    label: 'Governance',
    icon: 'lock',
    summary: 'Approval policies, feature flags, compliance, audit',
  },
  {
    id: 'privacy',
    label: 'Privacy',
    icon: 'shield',
    summary: 'Telemetry, memory data, sharing, residency',
  },
  {
    id: 'ai',
    label: 'AI',
    icon: 'sparkles',
    summary: 'Provider, model, execution & approval policy',
  },
  {
    id: 'workspace',
    label: 'Workspace',
    icon: 'grid',
    summary: 'Appearance, scale, startup experience, layout',
  },
  {
    id: 'organization',
    label: 'Organization',
    icon: 'command',
    summary: 'Departments, teams, people, digital workers, licenses',
  },
  {
    id: 'business',
    label: 'Business',
    icon: 'layers',
    summary: 'Finance, sales, CRM, procurement, inventory & operations areas',
  },
  {
    id: 'integrations',
    label: 'Integrations',
    icon: 'globe',
    summary: 'Connectors, OAuth, webhooks',
  },
  {
    id: 'companion',
    label: 'Companion',
    icon: 'globe',
    summary: 'Pair the NeuroPause mobile app, manage devices',
  },
  {
    id: 'developer',
    label: 'Developer',
    icon: 'package',
    summary: 'API keys, OAuth apps, plugins, sandbox, logs',
  },
  {
    id: 'billing',
    label: 'Billing',
    icon: 'store',
    summary: 'Subscription, licenses, usage, invoices',
  },
  {
    id: 'system',
    label: 'System',
    icon: 'pulse',
    summary: 'Updates, backup, recovery, health, devices',
  },
  {
    id: 'capabilities',
    label: 'Capabilities',
    icon: 'analytics',
    summary: 'What is available, managed, or not yet built',
  },
];
...
export const SETTINGS_SEARCH: SettingsSearchEntry[] = [
  {
    label: 'Profile',
    keywords: ['name', 'email', 'account', 'identity', 'who am i'],
    domain: 'identity',
    state: 'managed',
  },
  {
    label: 'Organizations & membership',
    keywords: ['org', 'organization', 'members', 'membership', 'invite', 'team'],
    domain: 'identity',
    state: 'editable',
  ...
  },
  {
    ...
    keywords: ['role', 'rbac', 'permission', 'access', 'admin'],
    domain: 'identity',
    state: 'editable',
    targetSection: 'enterprise',
  },
  {
    label: 'Connected accounts',
    keywords: ['connect', 'account', 'oauth', 'google', 'microsoft', 'github', 'slack', 'link'],
    domain: 'identity',
    state: 'editable',
  ...
  },
  {
    ...
    keywords: ['2fa', 'mfa', 'two factor', 'multi factor', 'authenticator'],
    domain: 'security',
    state: 'managed',
    targetSection: 'cloud',
  },
  {
    ...
    keywords: ['device', 'trusted', 'sessions', 'revoke device'],
    domain: 'security',
    state: 'editable',
  },
  {
    label: 'Recovery & safe mode',
    keywords: ['recovery', 'safe mode', 'repair', 'reset', 'restore'],
    domain: 'security',
    state: 'editable',
  ...
  {
    label: 'Feature flags',
    keywords: ['flag', 'feature', 'toggle', 'rollout', 'policy'],
    domain: 'governance',
    state: 'editable',
  },
  {
    label: 'Approval policies',
    keywords: ['approval', 'chain', 'governance', 'policy', 'escalation', 'delegation'],
    domain: 'governance',
    state: 'editable',
    targetSection: 'enterprise',
  },
  {
    label: 'Compliance',
    keywords: ['compliance', 'soc2', 'gdpr', 'iso', 'framework', 'residency'],
    domain: 'governance',
    state: 'managed',
    targetSection: 'cloud',
  },
  ...
  {
    label: 'Telemetry & crash reports',
    keywords: ['telemetry', 'crash', 'diagnostics', 'opt in', 'privacy', 'analytics'],
    domain: 'privacy',
    state: 'editable',
  },
  {
    label: 'Memory data',
    keywords: ['memory', 'forget', 'remember', 'data', 'knowledge'],
    domain: 'privacy',
    state: 'editable',
  ...
  {
    label: 'Data sharing',
    keywords: ['share', 'sharing', 'federation', 'cross org'],
    domain: 'privacy',
    state: 'editable',
    targetSection: 'federation',
  },
  {
    label: 'Data residency',
    keywords: ['residency', 'region', 'data location', 'sovereignty'],
    domain: 'privacy',
    state: 'managed',
    targetSection: 'cloud',
  },
  ...
  {
    label: 'Execution & approval policy',
    keywords: ['auto execution', 'automatic execution', 'auto exec', 'approval', 'autonomous'],
    domain: 'ai',
    state: 'managed',
    targetSection: 'auto-ops-center',
  },
  {
    label: 'Appearance',
  ...
  },
  {
    ...
    keywords: ['scale', 'zoom', 'size', 'font', 'display'],
    domain: 'workspace',
    state: 'editable',
  },
  {
  ...
  },
  {
    ...
    keywords: ['department', 'team', 'employee', 'people', 'member', 'org chart'],
    domain: 'organization',
    state: 'editable',
    targetSection: 'enterprise',
  },
  {
    ...
    keywords: ['worker', 'ai worker', 'workforce', 'agent', 'roster'],
    domain: 'organization',
    state: 'managed',
  ...
  },
  {
    ...
    keywords: ['business', 'erp', 'operations', 'modules', 'areas', 'records'],
    domain: 'business',
    state: 'editable',
  ...
  {
    label: 'Finance',
    keywords: ['finance', 'invoice', 'payment', 'receivable', 'billing records'],
    domain: 'business',
    state: 'editable',
    targetSection: 'business',
  },
  {
    label: 'Sales & CRM',
    keywords: ['sales', 'crm', 'quote', 'order', 'contact', 'lead', 'customer', 'pipeline'],
    domain: 'business',
    state: 'editable',
    targetSection: 'business',
  },
  {
    label: 'Procurement',
    keywords: ['procurement', 'supplier', 'purchase order', 'po', 'requisition', 'goods receipt'],
    domain: 'business',
    state: 'editable',
    targetSection: 'business',
  },
  {
    ...
    keywords: ['inventory', 'product', 'stock', 'warehouse', 'movement', 'bin', 'picking'],
    domain: 'business',
    state: 'editable',
    targetSection: 'business',
  },
  {
    label: 'Connectors',
    keywords: ['connector', 'integration', 'sync', 'github', 'slack', 'salesforce', 'notion'],
    domain: 'integrations',
    state: 'editable',
    targetSection: 'connectors',
  },
  {
    ...
    keywords: ['mobile', 'phone', 'companion', 'pair', 'pairing', 'qr', 'ios', 'android', 'app'],
    domain: 'companion',
    state: 'editable',
  },
  {
    label: 'Paired devices',
    keywords: ['paired', 'device', 'unpair', 'revoke phone', 'mobile device'],
    domain: 'companion',
    state: 'editable',
  },
  {
    label: 'Webhooks',
    keywords: ['webhook', 'callback', 'event', 'egress'],
    domain: 'integrations',
    state: 'editable',
  ...
  },
  {
    ...
    keywords: ['api key', 'oauth app', 'token', 'developer', 'sdk'],
    domain: 'developer',
    state: 'editable',
    targetSection: 'developer',
  },
  ...
  {
    label: 'Sandbox',
    keywords: ['sandbox', 'test', 'validation', 'experiment'],
    domain: 'developer',
    state: 'editable',
  ...
  },
  {
    ...
    keywords: ['subscription', 'plan', 'upgrade', 'billing', 'pay', 'manage billing'],
    domain: 'billing',
    state: 'editable',
  },
  {
    label: 'Licenses',
    keywords: ['license', 'seat', 'entitlement'],
    domain: 'billing',
    state: 'managed',
  },
  {
    label: 'Usage & invoices',
    keywords: ['usage', 'invoice', 'metering', 'cost', 'consumption'],
    domain: 'billing',
    state: 'managed',
    targetSection: 'commercial-center',
  },
  {
    label: 'Updates & release channel',
    keywords: ['update', 'version', 'release', 'channel', 'upgrade app'],
    domain: 'system',
    state: 'editable',
  },
  {
    label: 'Backup & recovery',
    keywords: ['backup', 'restore', 'recovery', 'snapshot'],
    domain: 'system',
    state: 'editable',
    targetSection: 'operations',
  },
  {
    ...
    keywords: ['health', 'runtime', 'status', 'diagnostics', 'system'],
    domain: 'system',
    state: 'managed',
    targetSection: 'opscenter',
  },
  {
    label: 'Device management',
    keywords: ['device', 'manage devices', 'revoke'],
    domain: 'system',
    state: 'editable',
  },
];
 ...
 */
export const CAPABILITY_INVENTORY: CapabilityEntry[] = CAPABILITY_REGISTRY.filter(
  (c) => c.state !== 'production-complete',
).map((c) => ({
