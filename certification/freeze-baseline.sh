...
SRC_DIRTY_SPEC=(-- . ':(exclude)certification' ':(exclude)CLAUDE.md' ':(exclude)NP_STATE.md' ':(exclude)BLOCKERS.md' ':(exclude)DECISIONS.md' ':(exclude)ROADMAP-HORIZON.md' ':(exclude)AUTONOMY.md' ':(exclude)WORK_QUEUE.md')
