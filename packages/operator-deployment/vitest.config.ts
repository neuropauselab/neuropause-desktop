...
export default defineConfig({
  resolve: {
    alias: {
      ...
      '@neuropause/release': pkg('release'),
      '@neuropause/platform-operations': pkg('platform-operations'),
      '@neuropause/customer-experience': pkg('customer-experience'),
      '@neuropause/enterprise-connectivity': pkg('enterprise-connectivity'),
      '@neuropause/trust-platform': pkg('trust-platform'),
      '@neuropause/deployment-orchestrator': pkg('deployment-orchestrator'),
      '@neuropause/platform-automation': pkg('platform-automation'),
      '@neuropause/environment-provisioning': pkg('environment-provisioning'),
    },
  },
