...
| Knowledge / Enterprise Knowledge | `apps/desktop/src/main/knowledge`, `apps/desktop/src/main/knowledgeFabric`, `apps/desktop/src/renderer/src/knowledgeCenter` | Search and retrieval over *administrative* policy, SOPs, formularies, internal guidance | Real surface; content is customer-supplied non-clinical documents |
