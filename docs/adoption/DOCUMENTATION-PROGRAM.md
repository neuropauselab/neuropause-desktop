...
| 3   | **How do I install it?**                          | Open the `NeuroPause.dmg` from your pilot contact and drag it to Applications ([`INSTALLATION.md`](../guides/INSTALLATION.md)). It is a universal build — one file for both Apple Silicon and Intel. An "unidentified developer" block means the build is unsigned, not that you have the wrong file; right-click → Open to proceed.                                                                                                                                               |
